...
// ══════════════════════════════════════════════════════════════════════════════
//   NEW FEATURES: Tags, Document Links, Analytics, Deadlines, Versions
// ══════════════════════════════════════════════════════════════════════════════
...
const Features = (() => {
    ...
    async function toggleTagOnSource(tagId, isActive) {
        ...
        try {
            ...
            // Refresh source list to show updated tags
    ...
    function showCalendarSyncModal() {
        ...
        // For now, show providers (OAuth would require backend implementation)
    }
    ...
    async function connectCalendar(provider) {
        ...
        // await fetch(`${API}/calendar/connect`, { method: 'POST', body: JSON.stringify({ provider }) });
    }
    ...
    let currentNoteId = 'write-main'; // Default for main write panel
    let allVersions = [];
    ...
    async function restoreVersion() {
        ...
        try {
            ...
            if (resp.ok) {
                // Fetch the note to get restored content
    ...
    async function saveVersion(content, changeSummary) {
        if (!window.currentNotebook) return;
        try {
            // Create or update note with new content (auto-versions)
