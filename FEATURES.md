...
- turn this into a short README summary and insert it at the top of the existing `hyphae/README.md`;
- or add a `FEATURES.md` to a different path (root-level) and update `README.md` with a link.

Tell me which you prefer and I can apply that change.
